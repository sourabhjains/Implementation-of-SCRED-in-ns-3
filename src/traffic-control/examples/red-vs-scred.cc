      ...
      if (modeBytes)
        {
          if (totalRxBytesCounter > 2771968)
            {
              std::cout << "SCRED Goodput is too high, should be about 10366.7 Bytes/sec" << std::endl;
              exit (-1);
            }
          else if (totalRxBytesCounter < 2654208)
            {
              std::cout << "SCRED Goodput is too low, should be about 10366.7 Bytes/sec" << std::endl;
              exit (-1);
            }
        }
      else
        {
          if (totalRxBytesCounter > 2765824)
            {
              std::cout << "SCRED Goodput is too high, should be about 10317.4 Bytes/sec" << std::endl;
              exit (-1);
            }
          else if (totalRxBytesCounter < 2636800)
            {
              std::cout << "SCRED Goodput is too low, should be about 10317.4 Bytes/sec" << std::endl;
              exit (-1);
            }
        }
    }
